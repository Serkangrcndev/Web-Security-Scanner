...
import { Shield, Zap, BarChart3, Lock, ArrowRight, CheckCircle, Target, Cpu, Eye, AlertTriangle, Home, Code, Download, Search, Activity, Bug, Network, Database, Fingerprint, Radar, Scan, AlertCircle, ShieldCheck, Clock, TrendingUp, Users, Globe, Server, Key, LockKeyhole, Folder, Star, Sparkles, Zap2, Target2, Crosshair, Binoculars, Telescope, Satellite, Wifi, WifiOff, Signal, SignalHigh, SignalMedium, SignalLow, ArrowUpRight, ArrowDownRight, ArrowLeftRight, RotateCcw, Play, Pause, Square, Timer, Gauge, BarChart4, PieChart as PieChartIcon, TrendingDown, Pulse, Heart, Zap2 as ZapIcon, Target2 as TargetIcon, Crosshair as CrosshairIcon, Binoculars as BinocularsIcon, Telescope as TelescopeIcon, Satellite as SatelliteIcon, Wifi as WifiIcon, WifiOff as WifiOffIcon, Signal as SignalIcon, SignalHigh as SignalHighIcon, SignalMedium as SignalMediumIcon, SignalLow as SignalLowIcon } from 'lucide-react';
...
export default function HomePage() {
  ...
  const features = [
    {
      ...
      description: 'AI-powered vulnerability scanning with real-time threat intelligence',
    ...
    },
    {
      ...
      description: 'Nmap, Nuclei, ZAP, SQLMap and more integrated scanning engines',
  ...
  const stats = [
    { label: 'Threats Detected', value: '2.8M+', change: '+15%', icon: AlertTriangle, color: 'text-red-400', trend: 'up' },
    { label: 'Sites Secured', value: '50K+', change: '+8%', icon: ShieldCheck, color: 'text-green-400', trend: 'up' },
    { label: 'Security Score', value: '99.2%', change: '+2.1%', icon: TrendingUp, color: 'text-blue-400', trend: 'up' },
    { label: 'Response Time', value: '<50ms', change: '-12%', icon: Clock, color: 'text-cyan-400', trend: 'down' },
  ];
  ...
  const scanningEngines = [
    { name: 'Nmap', status: 'active', icon: Network, color: 'from-blue-500 to-cyan-500', progress: 85, description: 'Network Discovery' },
    { name: 'Nuclei', status: 'active', icon: Bug, color: 'from-green-500 to-emerald-500', progress: 72, description: 'Vulnerability Scanner' },
    { name: 'ZAP', status: 'active', icon: Shield, color: 'from-purple-500 to-pink-500', progress: 63, description: 'Web App Security' },
    { name: 'SQLMap', status: 'active', icon: Database, color: 'from-red-500 to-orange-500', progress: 91, description: 'SQL Injection' },
    { name: 'Nikto', status: 'active', icon: Search, color: 'from-yellow-500 to-orange-500', progress: 45, description: 'Web Server Scanner' },
    { name: 'Dirb', status: 'active', icon: Folder, color: 'from-indigo-500 to-purple-500', progress: 78, description: 'Directory Brute Force' },
  ];
      ...
      <section className="relative px-4 py-32 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl text-center">
          ...
          >
            ...
            >
              Professional-grade vulnerability assessment platform. Detect, analyze, and eliminate 
              security threats with <span className="text-cyan-400 font-semibold">military-grade precision</span>.
            </motion.p>
            ...
            >
              {gamingFeatures.map((feature, index) => (
                ...
                >
                  ...
                  />
                  <span className="group-hover:text-cyan-400 transition-colors duration-300">{feature}</span>
                </motion.div>
              ))}
            </motion.div>
          </motion.div>
              ...
              >
                <Card className="bg-gray-900/50 border-gray-800 backdrop-blur-sm relative overflow-hidden">
                  ...
                  <CardHeader className="relative text-center">
                    <CardTitle className="flex items-center justify-center space-x-3 text-white text-3xl">
                      <motion.div 
                        className="w-16 h-16 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl p-4"
                        animate={{
                          rotate: [0, 360],
                        }}
                        transition={{
                      ...
                      <div>
                        <span>LIVE SCANNING DEMO</span>
                        <p className="text-sm text-gray-400 font-normal mt-2">Real-time threat detection in action</p>
                      </div>
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="relative">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                      ...
                      <div className="lg:col-span-2 space-y-6">
                        <div className="flex justify-between text-lg text-gray-300">
                          <span>Target: <span className="text-cyan-400 font-bold">demo-target.com</span></span>
                          <motion.span 
                        ...
                        <div className="w-full bg-gray-800 rounded-full h-6 overflow-hidden">
                          <motion.div
                            className="bg-gradient-to-r from-blue-500 to-cyan-500 h-6 rounded-full relative"
                    ...
                    {/* Scanning Engines */}
                    <div className="mt-8">
                      <h3 className="text-xl font-bold text-white mb-4 text-center">ACTIVE SCANNING ENGINES</h3>
                      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        {scanningEngines.map((engine, index) => (
                          ...
                          >
                            <motion.div 
                              className={`mx-auto w-12 h-12 bg-gradient-to-r ${engine.color} rounded-xl p-3 mb-2 group-hover:shadow-lg group-hover:shadow-cyan-500/25 transition-all duration-300`}
                              whileHover={{ rotate: 5 }}
                              transition={{ type: "spring", stiffness: 400, damping: 10 }}
                            >
                              <engine.icon className="h-6 w-6 text-white" />
                            </motion.div>
                            <p className="text-sm text-white font-medium mb-1">{engine.name}</p>
                            <p className="text-xs text-gray-400 mb-2">{engine.description}</p>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Built for security professionals, penetration testers, and ethical hackers
            </p>
          </motion.div>
                ...
                <Card className="h-full bg-gray-900/50 border-gray-800 hover:border-gray-700 transition-all duration-500 backdrop-blur-sm relative overflow-hidden">
                  ...
                  <CardContent className="text-center relative">
                    ...
                    <motion.div 
                      ...
                      transition={{ duration: 0.3 }}
                    >
                      <p className="text-2xl font-bold text-cyan-400">{feature.stats.value}</p>
                      <p className="text-xs text-gray-400">{feature.stats.label}</p>
                    </motion.div>
                  </CardContent>
                </Card>
              </motion.div>
           ...
           <div className="grid grid-cols-1 gap-8 md:grid-cols-3 px-4">
             {[
               ...
               <motion.div
                 ...
                 className="group cursor-pointer"
               >
                 <Card className={`h-full bg-gray-900/50 border-gray-800 hover:border-gray-700 transition-all duration-500 backdrop-blur-sm relative overflow-hidden flex flex-col ${plan.popular ? 'ring-2 ring-blue-500/50 shadow-lg shadow-blue-500/25' : ''}`}>
                   {plan.popular && (
                     <motion.div
             ...
             {[
               {
                 ...
                 description: 'All data is encrypted using AES-256 encryption both in transit and at rest. We never store sensitive information without proper encryption.',
                 gradient: 'from-blue-500 to-cyan-500'
               },
               {
                 icon: Shield,
                 title: 'Privacy First',
                 description: 'We follow strict privacy policies and never share your data with third parties. Your scan results and configurations remain completely private.',
                 gradient: 'from-green-500 to-emerald-500'
               },
               {
                 icon: Users,
                 title: 'GDPR Compliant',
                 description: 'Full compliance with GDPR, CCPA, and other privacy regulations. You have complete control over your data and can request deletion anytime.',
                 gradient: 'from-purple-500 to-pink-500'
               }
             ].map((item, index) => (
               <motion.div
             ...
             {[
               {
                 ...
                 features: ['Enhanced ML algorithms', 'Real-time threat intelligence', 'Improved scanning speed'],
                 type: 'major'
               },
               {
                 version: 'v2.0.5',
                 ...
                 description: 'Major performance improvements and bug fixes for better user experience.',
                 features: ['Faster scan execution', 'Reduced memory usage', 'UI responsiveness improvements'],
                 type: 'patch'
               },
               {
                 version: 'v2.0.0',
                 ...
                 description: 'Major redesign with new features, improved security, and better user interface.',
                 features: ['New dashboard design', 'Enhanced reporting system', 'API v2.0 release'],
                 type: 'major'
               }
             ].map((update, index) => (
               <motion.div
                 ...
                 <Card className="bg-gray-900/50 border-gray-800 hover:border-gray-700 transition-all duration-500 backdrop-blur-sm relative overflow-hidden">
                   <motion.div
                     className={`absolute inset-0 bg-gradient-to-r ${
                       update.type === 'major' ? 'from-blue-500/5 to-cyan-500/5' : 
                       update.type === 'patch' ? 'from-green-500/5 to-emerald-500/5' : 
                       ...
                       <div>
                         <div className="flex items-center space-x-3 mb-2">
                           <span className={`px-3 py-1 rounded-full text-xs font-bold ${
                             update.type === 'major' ? 'bg-blue-500/20 text-blue-400' : 
                             update.type === 'patch' ? 'bg-green-500/20 text-green-400' : 
                             'bg-purple-500/20 text-purple-400'
                           }`}>
                             {update.type.toUpperCase()}
                           </span>
                           <span className="text-2xl font-black text-white">{update.version}</span>
                         </div>
            ...
            <Card className="relative overflow-hidden bg-gradient-to-r from-blue-900/50 to-purple-900/50 border-blue-500/30">
              ...
              <CardContent className="relative p-16 text-center">
                ...
                <motion.p 
                  ...
                  viewport={{ once: true }}
                >
                  Join thousands of security professionals who trust SecurityScanner
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
        ...
        {isLoading && (
          ...
          >
            <div className="text-center">
              ...
              >
                Deploying advanced security protocols and threat detection systems...
              </motion.p>
